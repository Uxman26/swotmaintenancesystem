...
<script type="text/html" id="tmpl-media-library-view-switcher">
    <a href="/woffice/business/?mode=list" class="view-list">
        <span class="screen-reader-text">List View</span>
    </a>
    <a href="/woffice/business/?mode=grid" class="view-grid current">
...
<link rel='stylesheet' id='jquery-ui-datepicker-style-css'  href='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/css/jquery.datepicker.min.css') }}' type='text/css' media='all' />
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/bbpress/templates/default/js/editor.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/buddypress/bp-core/js/vendor/jquery.caret.min.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/buddypress/bp-core/js/vendor/jquery.atwho.min.js') }}'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var BP_Suggestions = {"friends":[{"ID":"woadmin","image":"\/\/www.gravatar.com\/avatar\/95d9bb1f8021331b8bafa39f664b7d5f?s=50&#038;r=g&#038;d=mm","name":"woadmin"}]};
    /* ]]> */
</script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/buddypress/bp-activity/js/mentions.min.js') }}'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var BP_Nouveau = {"ajaxurl":"https:\/\/demos.alkalab.com\/woffice\/business\/wp-admin\/admin-ajax.php","confirm":"Are you sure?","show_x_comments":"Show all %d comments","unsaved_changes":"Your profile has unsaved changes. If you leave the page, the changes will be lost.","object_nav_parent":"#buddypress","objects":["activity","members","groups","xprofile","friends","messages","settings","notifications","group_members","group_requests"],"nonces":{"activity":"e25a45059d","members":"77f3ca000b","groups":"3253891b81","xprofile":"e53bb0d0a9","friends":"7320065396","messages":"541596f3b4","settings":"b189104fe5","notifications":"4654ffe4e8"}};
    /* ]]> */
</script>
...
<script type='text/javascript' src='{{ asset('site/theme/wp-content/themes/woffice/js/dashboard.min.js') }}'></script>
...
<script type='text/javascript'>
    ...
    var WOFFICE_EVENTS = {
        ...
        "enable_event":"1",
        "field_options":{"woffice_event_title":{"type":"text","label":"Title","desc":"Set event name.","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_title"}},"woffice_event_date_start":{"type":"datetime-picker","label":"Event Starting Date","desc":"Will be used to display this event in the calendar.","min-date":"1-0-2000","datetime-picker":{"format":"Y-m-d H:i","minDate":0},"fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_date_start"}},"woffice_event_date_end":{"type":"datetime-picker","label":"Event Ending Date","desc":"Will be used to display this event in the calendar.","datetime-picker":{"format":"Y-m-d H:i","minDate":0},"fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_date_end"}},"woffice_event_repeat":{"type":"select","label":"Repeat","desc":"Select repeat type, Choose no if not repeatable event.","choices":{"No":"No","Daily":"Daily","Weekly":"Weekly","Monthly":"Monthly","Yearly":"Yearly"},"value":"No","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_repeat"}},"woffice_event_color":{"type":"select","label":"Event Color","desc":"Event color in calendar.","choices":{"default":"default","blue":"blue","orange":"orange","red":"red","green":"green","grey":"grey"},"value":"default","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_color"}},"woffice_event_visibility":{"type":"select","label":"Event Visibility","desc":"Set Event Visibility.","choices":{"personal":"Personal"},"value":"personal","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_visibility"}},"woffice_event_description":{"type":"textarea","label":"Description","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_description"}},"woffice_event_location":{"type":"text","label":"Location","desc":"Location of the event.","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_location"}},"woffice_event_link":{"type":"text","label":"Event URL","desc":"URL of the event.","fw-storage":{"type":"post-meta","post-meta":"fw_option:woffice_event_link"}},"new_event_label":"Add a new event","event_repeat_end_date_label":"Repeat until","edit_event_label":"Edit event","new_event_btn_save":"Create event","event_btn_save":"Save event","woffice_event_image_label":"Event image","create_event_label":"CREATE A NEW EVENT","event_chose_file_label":"Upload event image","import_ics_file_label":"Import .ics file instead","user":3,"advanced_settings":"Advanced settings","less_settings":"Collapse"}};
    /* ]]> */
</script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var _wpUtilSettings = {"ajax":{"url":"\/woffice\/business\/wp-admin\/admin-ajax.php"}};
    /* ]]> */
</script>
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var _wpMediaModelsL10n = {"settings":{"ajaxurl":"\/woffice\/business\/wp-admin\/admin-ajax.php","post":{"id":0}}};
    /* ]]> */
</script>
...
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/wise-chat/js/utils/messages_history.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/wise-chat/js/ui/messages.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/wise-chat/js/ui/settings.js') }}'></script>
{{--<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/wise-chat/js/maintenance/executor.js') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/wise-chat/js/wise_chat.js') }}'></script>--}}
{{--<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/wise-chat/js/3rdparty/moment.patched.min.js') }}'></script>--}}
<script type='text/javascript' src='{{ asset('site/theme/wp-includes/js/jquery/ui/datepicker.min.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/js/jquery.placeholder.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/js/jquery.selectric.min.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-includes/js/jquery/jquery.form.min.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/js/jquery.icheck.min.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/js/isotope.pkgd.min.js') }}'></script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/js/modulo-columns.js') }}'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var ProEventCalendarAjax = {"ajaxurl":"https:\/\/demos.alkalab.com\/woffice\/business\/wp-admin\/admin-ajax.php?lang=","postEventsNonce":"97958d21d8","recaptcha_enable":"","recaptcha_site_key":""};
    /* ]]> */
</script>
<script type='text/javascript' src='{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/js/jquery.dpProEventCalendar.js') }}'></script>
        ...
        if (window.matchMedia('(min-width: 992px)').matches) {
            $layout.find('.widget:not(.do-not-move)').each(function (i, itemElem) {
                ...
                draggie.on('dragEnd', function () {
                    ...
                    $.ajax({
                        url: 'https://demos.alkalab.com/woffice/business/wp-admin/admin-ajax.php',
                        data: {
                            'order': order,
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        function startProEventCalendar() {
            ...
            jQuery("#dp_pec_id1500675251").dpProEventCalendar({
                nonce: "dp_pec_id1500675251",
                draggable: false,
                map_lat: 0,
                map_lng: 0,
                columns: "",
                ...
                actualYear: 2019,
                actualDay: 24,
                defaultDate: "1569327980",
                defaultDateFormat: "2019-09-24",
                current_date_color: "",
                category: "",
                location: "",
                event_id: "",
            ...
            jQuery( ".dp_pec_date_input, .dp_pec_end_date_input, .dp_pec_extra_dates", "#dp_pec_id1500675251" ).datepicker({
                ...
                showOn: "button",
                isRTL: 0,
                buttonImage: "{{ asset('site/theme/wp-content/plugins/dpProEventCalendar/images/admin/calendar.png') }}",
            ...
            jQuery("input, textarea", "#dp_pec_id1500675251").placeholder();
        }


        if(jQuery("#dp_pec_id1500675251").parent().css("display") == "none") {
            jQuery("#dp_pec_id1500675251").parent().onShowProCalendar(function(){
    ...
    jQuery(window).resize(function(){
        if(jQuery(".dp_pec_layout", "#dp_pec_id1500675251").width() != null) {

            var instance = jQuery("#dp_pec_id1500675251");
...
<!--SWOT Script Customize, Global -->
<script type="text/javascript">
    $('#nav-notification-trigger-swot').click(function(){
        if($(this).find('i.fa').hasClass('fa-times'))
        {
            $('#woffice-notifications-menu').hide();
            $(this).find('i.fa').removeClass("fa-times");
            $(this).find('i.fa').addClass("fa-bell");
        }
        else
        {
            $('#woffice-notifications-menu').show();
            $(this).find('i.fa').removeClass("fa-bell");
